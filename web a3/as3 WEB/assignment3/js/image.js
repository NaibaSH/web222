...
window.onload = function() {
    var image1Element = document.querySelector("#image1");
    var image1 = "";

    for (var i =0; i < images.length; i++) {
        image1 += "<figure>";

            image1 += "<img src = '" + images[i].url + "' alt= '" + images[i].alt +"'>";
            image1 += "<figcaption>" + images[i].caption + "</figcaption>";
        image1 += "</figure>";
    }

    image1Element.innerHTML = image1;
